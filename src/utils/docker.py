...
def is_ollama_available(ollama_url: str) -> bool:
    ...
    try:
        ...
        print(f"{Fore.YELLOW}请确保Docker环境中的Ollama服务正在运行。{Style.RESET_ALL}")
        return False
...
def download_model(model_name: str, ollama_url: str) -> bool:
    ...
    while total_wait_time < max_wait_time:
        ...
        if total_wait_time % 60 == 0:
            ...
            print(f"{Fore.CYAN}下载进行中... (已用时 {minutes} 分钟){Style.RESET_ALL}")
