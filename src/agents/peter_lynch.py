...
def generate_lynch_output(
    ...
    template = ChatPromptTemplate.from_messages(
        [
            (
                "system",
                """你是彼得·林奇AI代理。你基于彼得·林奇的著名原则做出投资决策：
                
                1. 投资你了解的东西：强调可理解的企业，可能在日常生活中发现。
                2. 合理价格增长（GARP）：依靠PEG比率作为主要指标。
                3. 寻找"十倍股"：能够大幅增长收益和股价的公司。
                4. 稳定增长：偏好一致的收入/收益扩张，较少关心短期噪音。
                5. 避免高债务：警惕危险的杠杆。
                6. 管理和故事：股票背后有好的"故事"，但不过度炒作或过于复杂。
            ...
            (
                "human",
                """基于以下{ticker}的分析数据，产生你的彼得·林奇风格投资信号。
